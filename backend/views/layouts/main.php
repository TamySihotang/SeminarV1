...
<html lang="en-US">
    <head>
        <title>Sistem Informasi Seminar</title>
        ...
        <link rel="stylesheet" type="text/css" href='admin/fileinput.css' />
        <script type="text/javascript" src="admin/assets/3rd/jquery/jquery-core.js"></script>
        <script type="text/javascript" src="admin/fileinput.js"></script>
        ...
        <div id="tm-header-nav" class="tm-menu-style1 tm-sticky-menu" >
            <img alt="img" style="width:150px; height:150px; float:left; margin-left:50px; margin-right:-150px" src="nav/S.png">
            <div class="tm-wrap tm-table">
                <nav class="tm-nav">
                    <ul class="tm-menu tm-menu-simple">
                        <li class="current-menu-item parent" style="float:left">
...
//                                                                    'brandLabel' => 'Seminar',
                            ...
                            if (Yii::$app->user->isGuest) {
                                ...
                                $menuItems[] = ['label' => 'Signup', 'url' => '/advanced/frontend/web/index.php?r=site%2Fsignup'];
                                ['label' => 'Home', 'url' => ['/site/index']];
                            } else {
                                $menuItems[] = ['label' => 'Home', 'url' => ['/site/index']];
                                $menuItems[] = ['label' => 'My Paper', 'url' => ['/paper']];
                                $menuItems[] = ['label' => 'News', 'url' => ['/news']];
                                $menuItems[] = ['label' => 'My Profil', 'url' => ['/user/view', 'id' => Yii::$app->user->identity->id]];
