    ...
    <script type="text/javascript" src="admin/assets/js/jssor.js"></script>
    <script type="text/javascript" src="admin/assets/js/jssor.slider.js"></script>
    <script>
    ...
    <div id="slider1_container" style="position: relative; margin: 0 auto;
        ...
        <div u="loading" style="position: absolute; top: 0px; left: 0px;">
            ...
            <div style="position: absolute; display: block; background: url(admin/assets/image/img/loading.gif) no-repeat center center;
                top: 0px; left: 0px; width: 100%; height: 100%;">
            </div>
        </div>
        <!-- Slides Container -->
        <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 1300px;
            ...
            <div>
                <img u="image" src="admin/assets/image/img/1920/snikom3.jpg" />
                
                
                
            </div>
            <div>
                <img u="image" src="admin/assets/image/img/1920/snikom2.jpg" />
                ...
                <div style="position: absolute; width: 480px; height: 120px; top: 300px; left: 30px; padding: 5px;
                    text-align: left; line-height: 36px; font-size: 30px;
                        color: #FFFFFF;">
                        Disksusi, memecahkan masalah dan mencapai tujuan
                </div>
            </div>
            <div>
                <img u="image" src="admin/assets/image/img/1920/snikom4.jpg" />
                <div style="position: absolute; width: 480px; height: 120px; top: 30px; left: 30px; padding: 5px;
                    text-align: left; line-height: 60px; text-transform: uppercase; font-size: 50px;
                        color: #FFFFFF;">SNIKOM
                </div>
            ...
            <style>
                .share-icon {
                    ...
                    background-image: url(admin/assets/image/img/share/share-icons.png);
                }
        ...
        <style>
            ...
            */
            ...
            {
                background: url(admin/assets/image/img/b21.png) no-repeat;
                overflow:hidden;
                cursor: pointer;
            }
        ...
        <style>
            ...
            */
            .jssora21l, .jssora21r, .jssora21ldn, .jssora21rdn
            {
            	...
            	cursor: pointer;
            	display: block;
                background: url(admin/assets/image/img/a21.png) center center no-repeat;
                overflow: hidden;
            }
